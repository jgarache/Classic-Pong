...
void Game::ProcessInput()
{
	...
	// Update paddle left direction based on W/S keys
	mLeftPaddleDir = 0;
	...
	// Update paddle right direction based on W/S keys
	mRightPaddleDir = 0;
...
void Game::UpdateGame()
{
	...
	// Update paddle left position based on direction
	if (mLeftPaddleDir != 0)
	{
	...
	// Update paddle right position based on direction
	...
	// Bounce if needed
	// Did we intersect with the paddle left?
	...
	// Did we intersect with the paddle right?
	...
	// Did the ball go off the screen on the left/right? (if so, end game)
